...
<div class="container" style="padding:0; margin-top: -4em;">
  ...
  <section class="dashboard-header no-padding-bottom col-left-no-padding" style="margin-top: 4em;">
    <div class="container">
      <div class="row">
        <a href="<?= BASE_URL ?>tickets/assigned_to_me" class="col-md-3">
            ...
            <div class="work-amount">
              <div class="card-body">
                <div class="chart text-center">
                  ...
                  <canvas id="pieChart" style="display: block; width: 100%"></canvas>
                </div>
          ...
          <div class="recent-updates card custom-border-radius">
            ...
            <div class="card-header tab-card-header shadow-none">
              <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link disabled-text active show" id="one-tab" data-toggle="tab" href="#one" role="tab" aria-controls="One" aria-selected="false">Recently Assigned On Me</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link disabled-text" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="Two" aria-selected="false">Recent Closed On Me</a>
                </li>
              </ul>
            </div>
  ...
  <script>
    ...
    var myPieChart = new Chart(PIECHART, {
      ...
      data: {
        ...
        datasets: [{
          data: [<?= $stats['assigned_tickets'] ?>, <?= $stats['closed_tickets'] ?>],
          borderWidth: [0, 0, 0, 0],
          backgroundColor: [
            "#17a2b8",
            "#ff7676"
