...
<li><a href="<?= base_url('user/userGuide') ?>"><i class="fa fa-book"></i>User Guide</a></li>
<li><a href="<?= BASE_URL ?>expertsystem/diagnose"> <i class="fa fa-globe"></i>Expert System <span class="badge badge-warning">Beta</span></a></li>
