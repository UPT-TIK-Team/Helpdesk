...
<body>
    ...
    <div class="page">
        ...
        <p>
            <strong>Hey!</strong> You can automatically create a ticket by sending an email to helpdesk@staff.unsika.ac.id. You can also reply to any ticket thread from the notification email thread itself !
